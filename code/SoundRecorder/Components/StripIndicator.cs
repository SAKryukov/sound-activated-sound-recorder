...
namespace SoundRecorder.Components {
    ...
    public partial class StripIndicator : ContentControl {
        ...
        void Refresh() {
            static bool isNormalValue(double value) =>
                !(value < 0 || double.IsPositiveInfinity(value) || double.IsNaN(value));
            double fullSize;
        ...
        readonly Rectangle valueRectangle = new();
        readonly Rectangle thresholdRectangle = new();
